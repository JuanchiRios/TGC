...
namespace AlumnoEjemplos.MiGrupo
{
    class MotionBlur
    {
        ...
        public MotionBlur(List<TgcMesh> unosMeshes)
        {
            meshes = new List<TgcMesh>();
            meshes.AddRange(unosMeshes);
        }


        public void motionBlurInit(int profundidad)
        {
            ...
            effect = Effect.FromFile(GuiController.Instance.D3dDevice, GuiController.Instance.AlumnoEjemplosMediaDir + "TheC#\\Shaders\\\\MotionBlur.fx",
        ...
        public void motionBlurRender(float elapsedTime, float currentFPS, float velocidadAuto, int profundidad)
        {
            ...
            effect.SetValue("currentFPS", currentFPS);
            effect.SetValue("carSpeed", velocidadAuto);
            device.Clear(ClearFlags.Target | ClearFlags.ZBuffer, Color.Black, 1.0f, 0);
